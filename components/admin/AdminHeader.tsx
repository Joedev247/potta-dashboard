...
import { Bell, User, Question, Gear, SignOut, Download, ChatCircle, ArrowSquareOut, List } from '@phosphor-icons/react';
...
export default function AdminHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 lg:left-64 right-0 h-16 bg-white border-b border-gray-200 z-30 flex items-center justify-between px-4 sm:px-6">
      {/* Left side - Hamburger Menu (Mobile) - Note: Admin sidebar manages its own mobile menu */}
      <div className="flex items-center gap-2 sm:gap-4">
        {/* Mobile menu is handled by AdminSidebar component */}
      </div>
